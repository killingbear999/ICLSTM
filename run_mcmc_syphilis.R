...
# init_fun <- function() {
#   list(beta = 0.1, phi_beta = 0.1, epsilon=0.1, rho=20.94, eta_H_init=0.1, phi_eta=0.1, omega=0.451, sigma=17, mu=239.5, psi_S=10.83, psi_E=2.17, psi_L=0.541, psi_T=0.064, nu=0.0419, kappa_D=0.1, beta_nu=0.8)
# }
